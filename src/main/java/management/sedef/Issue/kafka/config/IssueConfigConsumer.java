...
@Configuration
public class IssueConfigConsumer {
    ...
    @Bean(name = "issueConsumerFactory")  // İsim verildi
    public <T> ConsumerFactory<String, IssueUserEvent> consumerFactory() {
    ...
    @Bean(name = "issueKafkaListenerContainerFactory")  // İsim verildi
    public <T> ConcurrentKafkaListenerContainerFactory<String, IssueUserEvent> kafkaListenerContainerFactory() {
