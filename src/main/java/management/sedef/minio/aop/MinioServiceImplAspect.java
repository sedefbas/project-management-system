package management.sedef.minio.aop;
...
public class MinioServiceImplAspect {
    ...
    @Before(value="execution(* management.sedef.minio.service.MinioService.*(..))")
    public void beforeAdvice(JoinPoint joinPoint){
        System.out.println("MinioServiceImplAspect | Before MinioService method got called");
    }

    @After(value="execution(* management.sedef.minio.service.MinioService.*(..))")
    public void afterAdvice(JoinPoint joinPoint){
        System.out.println("MinioServiceImplAspect | After MinioService method got called");
    }

    @AfterReturning(value="execution(* management.sedef.minio.service.MinioService.*(..))")
